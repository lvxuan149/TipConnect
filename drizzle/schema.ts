import { pgTable, text, varchar, numeric, bigint, timestamp, index, uniqueIndex, uuid, integer, jsonb } from "drizzle-orm/pg-core";
...
export const storyMetricsDaily = pgTable("story_metrics_daily", {
  ...
  byStory: index("idx_story_metrics_story_id").on(t.story_id),
